...
function Loading() {
  return (
    <>
      <svg className="oven" width="204" height="204" viewBox="0 0 204 204" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect y="13" width="204" height="178" rx="3" stroke="#0F0F0F" strokeWidth="10" mask="url(#path-1-inside-1_116_16)" />
        ...
        <rect x="126" y="124" width="36" height="12" rx="3" fill="#E1B45C" stroke="#782C01" strokeWidth="10" mask="url(#path-4-inside-4_116_16)" />
        <mask id="path-5-inside-5_116_16" fill="white">
          <rect x="84" y="124" width="36" height="12" rx="3" />
        </mask>
        <rect x="84" y="124" width="36" height="12" rx="3" fill="#E1B45C" stroke="#782C01" strokeWidth="10" mask="url(#path-5-inside-5_116_16)" />
        <mask id="path-6-inside-6_116_16" fill="white">
          <rect x="42" y="124" width="36" height="12" rx="3" />
        </mask>
        <rect x="42" y="124" width="36" height="12" rx="3" fill="#E1B45C" stroke="#782C01" strokeWidth="10" mask="url(#path-6-inside-6_116_16)" />
        <mask id="path-7-inside-7_116_16" fill="white">
          <rect x="14" y="75" width="176" height="20" rx="3" />
        </mask>
        <rect x="14" y="75" width="176" height="20" rx="3" fill="#BDBDBD" stroke="#3A3A3A" strokeWidth="10" mask="url(#path-7-inside-7_116_16)" />
        <mask id="path-8-inside-8_116_16" fill="white">
          <rect y="13" width="204" height="47" rx="3" />
        </mask>
        <rect y="13" width="204" height="47" rx="3" fill="#BCBCBC" stroke="#0F0F0F" strokeWidth="10" mask="url(#path-8-inside-8_116_16)" />
        <rect x="117.5" y="2.5" width="60" height="12" rx="3.5" fill="#BDBDBD" stroke="#0F0F0F" strokeWidth="5" />
        <rect x="25.5" y="2.5" width="60" height="12" rx="3.5" fill="#BDBDBD" stroke="#0F0F0F" strokeWidth="5" />
        <mask id="path-11-inside-9_116_16" fill="white">
          <rect x="168" y="187" width="26" height="17" rx="3" />
        </mask>
        <rect x="168" y="187" width="26" height="17" rx="3" fill="#9F9696" stroke="#0F0F0F" strokeWidth="10" mask="url(#path-11-inside-9_116_16)" />
        ...
        <defs>
          ...
          <linearGradient className="oven-gradient" id="paint1_linear_116_16" x1="102" y1="170" x2="102" y2="78" gradientUnits="userSpaceOnUse">
